...
my @data = (
    ...
    },
    {
        ...
        template => '<%TEXT "text_singular2" COUNT="2"%>',
        result   => 'text=text_singular2;count=2',
    },
    {
        test     => 'gettext plural',
        template => '<%TEXT "text_singular3" PLURAL="text_plural3" COUNT="2"%>',
        result   => 'text=text_singular3;plural=text_plural3;count=2',
    },
    {
        test     => 'gettext plural, all as var',
        template => '<%TEXT VALUE="var_singular" PLURAL_VAR="var_plural" COUNT_VAR="var_count"%>',
        params   => {
    ...
    {
        test     => 'gettext all',
        template => '<%TEXT "text_singular7" PLURAL="text_plural7" COUNT="2" CONTEXT="context7" _name="gt7"%>',
        result   => 'context=context7;text=text_singular7;plural=text_plural7;count=2;gettext=name,gt7',
    },
    {
        test     => 'gettext all, all as var',
        template => '<%TEXT VALUE="var_singular" PLURAL_VAR="var_plural" COUNT_VAR="var_count" CONTEXT_VAR="var_context" _name_VAR="var_name"%>',
        params   => {
